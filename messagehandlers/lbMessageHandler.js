...
exports.showLeaderBoard = async (msg, authorId = null) => {
  ...
  for (let i = 0; i < members.length; i++) {
    ...
    try {
      ...
      let test = await msg.guild.members.cache.get(members[i][0])
      currentUser = await msg.guild.members.cache.get(members[i][0])
  ...
  console.log('final',userNames, score, scoreAuth, position,)
